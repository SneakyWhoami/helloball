...
public class JavaModel {
    ...
    public void onDisplayListChanged(String json) {
        ...
        try {
            SparseArray<com.balsamiq.HelloBall.Ball> balls = new SparseArray<com.balsamiq.HelloBall.Ball>();
            ...
            while (iterator.hasNext()) {
                ...
                com.balsamiq.HelloBall.Ball ball = new com.balsamiq.HelloBall.Ball((float) x, (float) y, (float) radius, color);
