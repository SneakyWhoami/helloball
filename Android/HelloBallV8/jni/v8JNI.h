...
#include <jni.h>
/* Header for class com_balsamiq_HelloBallV8_JavaModelWrapper */

#ifndef _Included_com_balsamiq_HelloBallV8_JavaModelWrapper
#define _Included_com_balsamiq_HelloBallV8_JavaModelWrapper
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_balsamiq_HelloBallV8_JavaModelWrapper
 * Method:    loadJS
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_balsamiq_HelloBallV8_JavaModelWrapper_loadJS
 ...
 * Signature: (DD)V
 */
JNIEXPORT void JNICALL Java_com_balsamiq_HelloBallV8_JavaModelWrapper_onMouseDown
  (JNIEnv *, jobject, jdouble, jdouble);
